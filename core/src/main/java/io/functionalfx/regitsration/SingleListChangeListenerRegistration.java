...
class SingleListChangeListenerRegistration<T> implements ListenerRegistration {

    private ObservableList<T> observableList;
    private ListChangeListener<T> changeListener;
    private boolean isUnregistered;

    public SingleListChangeListenerRegistration(ObservableList<T> observableList, ListChangeListener<T> listener) {
